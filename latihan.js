...
// Write, Edit and Run your Javascript code using JS Online Compiler// Mendefinisikan Kelas
class Mobil {
...
// Membuat Objek
const mobil1 = new Mobil('Marcedes', 'biru');
mobil1.jalan(); // Output: Marcedes berwarna biru sedang berjalan.

const mobilBalap1 = new MobilBalap('Lamborghini', 'hitam', 500);
